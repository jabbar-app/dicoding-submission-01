...
import id.jabbar.githubusers.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    companion object {
        private const val STATE_SEARCH_VIEW: String = "state_search_view"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val drawable = ResourcesCompat.getDrawable(resources, R.drawable.ic_github, null)
        val bitmap = drawable?.toBitmap()
        val scaledDrawable = BitmapDrawable(resources,
            bitmap?.let { Bitmap.createScaledBitmap(it, 180, 180, true) })
